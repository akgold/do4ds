...
Encompasses parts of DevOps, MLOps, DataOps.

If you're in an environment where you just do data science on your laptop, you probably don't really need this book. You might find the sections on the command line and on data access interesting, but most of this book will be geared towards server-based data science – whether that's working in a browser-based data science IDE or trying to deploy data science assets to a server. 
