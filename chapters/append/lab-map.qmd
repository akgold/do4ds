...
Final product: Quarto site on Palmer Penguins on GitHub Pages w/ GHA to
re-render on push.

Pages: Quarto EDA page, Jupyter NB model building page, iFrame of Shiny
App for model visualization

Shiny app (in Docker) hosted on EC2 instance w/ FastAPI (Docker) -- also
has JupyterHub + RStudio Server.

Backend: DuckDB hosted on EC2 instance. Or RDS instance?

![](images-append/lab-arch.jpeg)
