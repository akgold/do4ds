...
| [@sec-deployments]: Code Promotion         | Put a static Quarto site up on GitHub Pages using GitHub Actions that renders the project.                                                          |
...
| [@sec-linux]: Linux Admin            | Add R, Python, RStudio Server, JupyterHub, palmer penguin fastAPI + App.                                                                            |
| [@sec-networking]: Networking          | Add proxy (nginx) to reach all services from the web.                                                                                               |
