...
| Command                            | What it does                                            | Helpful options + notes                                                                                          |
|------------------------------------|---------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
| `ch m od <per m i s sions> <file>` | Modifies permissions on a file.                         | Number indicates permissions for user, group, others: add 4 for read, 2 for write, 1 for execute, 0 for nothing. |
| `c h own <us e r / group> <file>`  | Change the owner of a file.                             | Can be used for user or group, e.g. `:my-group`.                                                                 |
| `su <username>`                    | Change active user to `username`.                       |                                                                                                                  |
...
| `ln -s < lo cation to link>: < l ocation of symlink>` | Creates a symlink from file at `location to link` to `location of symlink`. |
