...
| Database                    | RDS or Redshift\[\^2-1-cloud-8\]                     | Azure Database                 | Google Cloud SQL               |
...
|--------------------------------|---------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
| `chm od <permissi ons> <file>` | Modifies permissions on a file.                         | Number indicates permissions for user, group, others: add 4 for read, 2 for write, 1 for execute, 0 for nothing. |
| `cho wn  <user/gr oup> <file>` | Change the owner of a file.                             | Can be used for user or group, e.g. `:my-group`.                                                                 |
