...
| e |                   |                   |                          |
+---+-------------------+-------------------+--------------------------+
| B | `docker b         | Builds a          | `-t <name:tag>` provides |
| u | uild <directory>` | directory into an | a name to the container. |
| i |                   | image.            |                          |
| l |                   |                   | `tag` is optional,       |
| d |                   |                   | defaults to `latest`.    |
+---+-------------------+-------------------+--------------------------+
| M | `doc              | Push a container  |                          |
| o | ker push <image>` | to a registry.    |                          |
| v |                   |                   |                          |
| e |                   |                   |                          |
+---+-------------------+-------------------+--------------------------+
| M | `doc              | Pull a container  | Rarely needed because    |
| o | ker pull <image>` | from a registry.  | `run` pulls the          |
| v |                   |                   | container if needed.     |
| e |                   |                   |                          |
+---+-------------------+-------------------+--------------------------+
| R | `do               | Run a container.  | See flags in next table. |
| u | cker run <image>` |                   |                          |
| n |                   |                   |                          |
+---+-------------------+-------------------+--------------------------+
| R | `docker           | Stop a running    | `docker kill` can be     |
| u | stop <container>` | container.        | used if `stop` fails.    |
| n |                   |                   |                          |
+---+-------------------+-------------------+--------------------------+
| R | `docker ps`       | List running      | Useful to get container  |
| u |                   | containers.       | `id` to do things to it. |
| n |                   |                   |                          |
+---+-------------------+-------------------+--------------------------+
| R | `                 | Run a command     | Basically always used to |
| u | docker exec <cont | inside a running  | open a shell with        |
| n | ainer> <command>` | container.        | `docker exec -i          |
|   |                   |                   | t <container> /bin/bash` |
+---+-------------------+-------------------+--------------------------+
| R | `docker           | Views logs for a  |                          |
| u | logs <container>` | container.        |                          |
| n |                   |                   |                          |
+---+-------------------+-------------------+--------------------------+
...
|            |               |            |            |            |
| Kubernetes | EKS (Elastic  | AKS (Azure | GKE        |            |
| cluster    | Kubernetes    | Kubernetes | (Google    |            |
|            | Service) or   | Service)   | Kubernetes |            |
|            | Fargate       |            | Engine)    |            |
+------------+---------------+------------+------------+------------+
|            |               |            |            |            |
+------------+---------------+------------+------------+------------+
| Run a      | ECS (Elastic  | Azure      | Google App |            |
...
| Platform   |               |            |            |            |
+------------+---------------+------------+------------+------------+
| NAS        | EFS (Elastic  | Azure File | Filestore  |            |
|            | File System)  |            |            |            |
|            | or FSx        |            |            |            |
+------------+---------------+------------+------------+------------+
