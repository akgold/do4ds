...
writing, PAM is the default authentication method for \index{RStudio
Server} and \index{JupyterHub}.
...
user's home directory. For example, if you've accessed \index{Google Sheets} or
