...
In [Chapter @sec-basic-networks] you learned all about how IP addresses are
...
[Chapter @sec-basic-networks] introduced full URLs. Where the main address
...
In [Chapter @sec-basic-networks], we discussed how packets gets routed to
