# Upgraded Networking {#sec-networking-2}

In [Chapter @sec-networking-1] we went over a general introduction to networking, including an introduction to DNS, how to get and use a real URL, and making sure your servers are secure with SSL/HTTPS.
