...
In [Chapter @sec-networking] we went over a general introduction to
...
In [Chapter @sec-networking], we talked about the analogy of a
...
As we went over in [Chapter @sec-networking], network traffic
