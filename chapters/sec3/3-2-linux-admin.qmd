...
| Command                    | What it does             |
+============================+==========================+
| `apt-g e t u p             | Fetch and install        |
| date && apt-get upgrade y` | upgrades to system       |
|                            | packages                 |
+----------------------------+--------------------------+
| `                          | Install a system         |
...
the default name, probably `id_ed25519`.[^3-2-linux-admin-12] The `ssh`
command knows to automatically used a default key, so you no longer need
the `-i` option.

[^3-2-linux-admin-12]: The pattern is `id_<encryption type>`. `ed25519`
