...
|                      |                | notes          |
+======================+================+================+
| `c h m o d <         | Modifies       | Number         |
| permissions> <file>` | permissions on | indicates      |
|                      | a file.        | permissions    |
|                      |                | for user,      |
|                      |                | group, others: |
|                      |                | add 4 for      |
...
``` {.bash eval="false" include="../../_labs/server-config/shiny-server.conf"
filename="/etc/shiny-server/shiny-server.conf"}
