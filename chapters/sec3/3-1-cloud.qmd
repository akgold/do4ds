...
app that dynamically scales (alternatively, Azure App Engine/GCP App Service), if you want
to run a container, you might use AWS ECS/Azure CI/GCP Cloud Run, and if you want to get a
Kubernetes cluster as a service, you might use AWS EKS/Azure AKS/GCP GKE. If you want to just
