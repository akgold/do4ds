...
### Put the penguins model in S3

TODO - running into errors in py.pins?

### Stand up a database for the penguins data

Stand up redshift

Note: public access not allowed, recommend you create an sg that only
allows access from your EC2 instance.
