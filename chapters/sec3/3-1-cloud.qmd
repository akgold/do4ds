...
``` {.python eval="false" include="../../_labs/model/model-vetiver.qmd" filename="model.qmd" start-line="47" end-line="50"}
```

That line will now become

``` {.python eval="false" include="../../_labs/model/model-vetiver.qmd" filename="model.qmd" start-line="64" end-line="68"}
```
...
``` {.python eval="false" include="../../_labs/model/model-vetiver.qmd" filename="model.qmd" start-line="56" end-line="58"}
```
...
``` {.python include="../../_labs/docker/build-docker-s3.qmd" start_line=11 end_line=19}
```
