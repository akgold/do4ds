...
[^3-2-auth-3]: There is a technology called *Kerberos* that some
    organizations use to accomplish SSO with LDAP/AD, though this is
    rare.
...
like biometrics and passphrases and the use of OAuth to do sophisticated
authorization management inside enterprises are now cutting-edge, but
will be standard practices within a few years.
...
3.  What are some advantages of token-based auth? Why are most
