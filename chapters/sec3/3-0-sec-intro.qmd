...
Most data scientists can't stand up and use data science servers at
their discretion. Many organizations operate with security and process
requirements or at a scale that requires professional IT/Admins to
...
This section of the book will to help you understand the IT/Admins'
point of view in an enterprise. By the end of the subsequent few
chapters, I hope you know why they don't just let you set up servers,
that you understand their tools, and that you are prepared to articulate
...
open-source tools, like \index{JupyterHub} and \index{RStudio Server}. Conversely, some
want to buy seats on a SaaS solution.
...
I have seen many organizations decline to buy \index{Posit}'s Pro Products in
favor of attempting to build a platform. Many come back 6 or 12 months
later, having discovered that DIY-ing an 80% solution is easy, but
creating a fully enterprise-ready data science environment from
...
As this section is about developing mental models and language to
collaborate with IT/Admins, there are no labs in this section of the
book. There are a lot of pictures and comprehension questions to ensure
