...
science workbench and a data science hosting environment.
...
1.  What is the advantage of adopting a more complex networking setup
    than a server deployed directly on the internet? Are there
...
3.  Let's say you've got a private VPC that hosts an instance of RStudio
    ...
    a few examples of traffic -- are they outbound, inbound, or within
    the network?
