...
### Comprehension Questions and Labs
...
Throughout the book, you'll also complete labs. Some chapters in the
book are more conceptual and don't include a lab, but many chapters do.

The idea of these labs is to build up a complete data science platform
that includes a place for you to work, a way to store data, and a
deployment environment.

By the time you're done, you'll have built a website with automated
deployment that includes an interactive web app and a workbench
environment in AWS for data science work in R or Python.

The whole thing will look something like this:

![](intro-images/lab-arch.jpeg)
