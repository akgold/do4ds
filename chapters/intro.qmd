...
To that end this book is divided into four sections.
...
in their work like the command line, bash, and Docker. These tools are
all useful for you to understand as a data scientist and also will be
useful if you end up having to do any IT/Admin tasks.

[Section 3](@sec-3-intro) is a walk through of basic concepts in IT
...
Section 3 changes when you go to enterprise scale. If section 3 explains
how to do IT/Admin tasks yourself, section 4 is my attempt to explain
why you shouldn't.
...
braces around them like `{package}`.
