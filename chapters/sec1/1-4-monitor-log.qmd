...
inside a Docker Container is ephemeral. This is bad if you're writing a
log that might contain clues for why a Docker Container was unexpectedly
killed.
:::
...
about, like data quality or API response times. There is an official
Prometheus client in Python and the `{openmetrics}` package in R makes
registering metrics from a Plumber API or Shiny app easy.
