...
2.  What are the two halves of the monitoring and logging process?
3.  What are some things you should *not* log?
4.  What are the different levels of logging, and what's an example of something you'd include at each level?

## Portfolio Exercise: Adding Logging

Take the app you built for [Chapter @sec-project-components]. Using the appropriate package for whichever language you wrote in, add robust logging to both the API and the App you built.
