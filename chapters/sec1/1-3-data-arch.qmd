...
``` {.r eval="false" include="../../_labs/data-load/r-data-load.R"}
```

Or equivalently, in Python:

``` {.python eval="false" include="../../_labs/data-load/py-data-load.py"}
```
...
``` {.r eval="false" include="../../_labs/eda/eda-db.qmd" filename="eda.qmd" start-line="14" end-line="19"}
```
...
``` {.r eval="false" include="../../_labs/eda/eda-db.qmd" filename="eda.qmd" start-line="23" end-line="32"}
```
...
``` {.python eval="false" include="../../_labs/model/model-db.qmd" filename="model.qmd" start-line="18" end-line="21"}
```
...
actutal database or by storing the DuckDB file in a centralized
location.
