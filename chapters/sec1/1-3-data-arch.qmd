...
``` {.r eval="false" include="../../labs/lab-3/eda-db.qmd" filename="eda.qmd" start-line=14 end-line=19}
```
...
``` {.python eval="false" include="../../labs/lab-3/model-db.qmd" filename="model.qmd" start-line=18 end-line=21}
```
