...
| project directory.  |                     |                |
+---------------------+---------------------+----------------+
| Make sure you've    | `ins t a l          | Included w/    |
| got                 | l.packages("renv")` | Python 3.5+    |
| `{renv}/{venv}`.    |                     |                |
+---------------------+---------------------+----------------+
...
|                     | using projects.     |                |
+---------------------+---------------------+----------------+
| Install packages as | `inst a l l         | `pyt           |
| normal.             | .packages("<pkg>")` |  hon -m p i p  |
|                     |                     | install <pkg>` |
+---------------------+---------------------+----------------+
...
+----------------+----------------------+----------------+
| Move into      | `s e t               | `c d           |
| project        | wd("<project-dir>")` | <project-dir>` |
| directory.     |                      |                |
|                | Or just open R       |                |
|                | project in RStudio.  |                |
+----------------+----------------------+----------------+
...
|                |                      | env for <dir>` |
+----------------+----------------------+----------------+
| Enter project  | Happens              | `so u          |
| environment.   | automatically.       | rce < d i r >  |
|                |                      | /bin/activate` |
+----------------+----------------------+----------------+
| Restore        | May happen           | `p ip ins t    |
| packages.      | automatically or     | all - r r e q  |
