...
| Step                 | R Command            | Python Command       |
+======================+======================+======================+
| Make sure you've got | `in s t a l          | Included w/ Python   |
| `{r  env}/{venv}`.   | l .packages("renv")` | 3.5+                 |
+----------------------+----------------------+----------------------+
| Create a standalone  | `renv::init()`       | `p y                 |
| library.             |                      | t hon -m venv <dir>` |
|                      |                      |                      |
|                      |                      | Convention:          |
|                      |                      | `u                   |
|                      |                      | s e .venv for <dir>` |
+----------------------+----------------------+----------------------+
| Activate project     | `renv::activate()`   | `sou r c e <         |
| library.             |                      | d ir> /bin/activate` |
|                      | Happens              |                      |
|                      | automatically if     |                      |
|                      | using projects.      |                      |
+----------------------+----------------------+----------------------+
| Install packages as  | `ins t a l l         | `pyth o n -          |
| normal.              | . packages("<pkg>")` | m pip install <pkg>` |
+----------------------+----------------------+----------------------+
...
| Step                 | R Command            | Python Command       |
+======================+======================+======================+
| Move into project    | `se t w              | `cd <project-dir>`   |
| directory.           | d ("<project-dir>")` |                      |
|                      |                      |                      |
|                      | Or just open R       |                      |
|                      | project in RStudio.  |                      |
+----------------------+----------------------+----------------------+
| Create project       | `renv::init()`       | `p y                 |
| environment.         |                      | t hon -m venv <dir>` |
|                      |                      |                      |
|                      |                      | Recommend:           |
|                      |                      | `u                   |
|                      |                      | s e .venv for <dir>` |
+----------------------+----------------------+----------------------+
| Enter project        | Happens              | `s o u rce <         |
| environment.         | automatically or     | d ir> /bin/activate` |
|                      | `renv::activate()`   |                      |
+----------------------+----------------------+----------------------+
| Restore packages.    | Happens              | `p ip i n s t all -  |
