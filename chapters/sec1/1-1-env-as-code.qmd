...
| `{r  env}/{venv}`. |                    |                    |
+--------------------+--------------------+--------------------+
| Create a           | `renv::init()`     | `p y t             |
| standalone         |                    | hon -m venv <dir>` |
| library.           |                    |                    |
|                    |                    | Convention:        |
|                    |                    | `u s               |
|                    |                    | e .venv for <dir>` |
...
|                    | using projects.    |                    |
+--------------------+--------------------+--------------------+
| Install packages   | `ins t a l l .     | `pyth o n - m      |
| as normal.         | packages("<pkg>")` | pip install <pkg>` |
+--------------------+--------------------+--------------------+
...
| Step               | R Command          | Python Command     |
+====================+====================+====================+
| Move into project  | `se t w d          | `cd <project-dir>` |
...
|                    | RStudio.           |                    |
+--------------------+--------------------+--------------------+
| Create project     | `renv::init()`     | `p y t             |
| environment.       |                    | hon -m venv <dir>` |
|                    |                    |                    |
|                    |                    | Recommend:         |
|                    |                    | `u s               |
|                    |                    | e .venv for <dir>` |
+--------------------+--------------------+--------------------+
| Enter project      | Happens            | `s o u rce < d     |
| environment.       | automatically or   | ir> /bin/activate` |
|                    | `renv::activate()` |                    |
+--------------------+--------------------+--------------------+
| Restore packages.  | Happens            | `p                 |
|                    | automatically or   | ip i n s t all - r |
|                    | `renv::restore()`  |  requirements.txt` |
+--------------------+--------------------+--------------------+
