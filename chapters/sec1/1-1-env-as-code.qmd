...
using \index{Git}Git. So, check your `lockfile` or `requirements.txt`
into \index{Git}Git with your project.
...
If you're already comfortable with Quarto and want to focus on the DevOps aspects, you can just use the scripts I wrote from the
