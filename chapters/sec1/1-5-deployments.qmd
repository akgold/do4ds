...
with 35,000 feet of air below than 50.[^1-5-code-promotion-1]

[^1-5-code-promotion-1]: It's worth noting that commercial air travel is
...
CI/CD.[^1-5-code-promotion-2]

[^1-5-code-promotion-2]: Prior to the release of GHA, Travis and Jenkins
