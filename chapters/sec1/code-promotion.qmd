...
The common term for the mechanics of code promotion is Continuous Integration/Continuous Deployment (CI/CD).[^code-promotion-2]
...
[^code-promotion-3]: It's worth remarking that GitLab has long offered a very good CI/CD integration. I'm going to talk about GHA, since it's the most popular, but you can accomplish these same things with GitLab CI/CD.
