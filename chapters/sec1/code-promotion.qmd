...
![](images-code-promotion/code-promotion.jpeg "Code + Server Promotion Patterns"){width="467"}
...
![](images-code-promotion/git_branches.jpeg){width="474"}
...
Sometimes you want a little more flexibility -- for example the option to switch many the environment variables depending on the environment. In R, the standard way to do this is using the [`config`](https://cran.r-project.org/web/packages/config/index.html) package. There are many options for managing runtime configuration in Python.
