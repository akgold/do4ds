...
|              |              |              | arkdown/Jupyter |
+--------------+--------------+--------------+-----------------+
| Back End     | Ap plication | API          | Functions *or*  |
|              |              |              | API             |
+--------------+--------------+--------------+-----------------+
...
``` {.python eval="false" include="../../_labs/model/model-vetiver.qmd" filename="model.qmd" start-line="44"}
```
...
``` {.r eval="false" include="../../_labs/shiny-app/app-basic.R" filename="app.R"}
```
