# Understanding, Using, and Building APIs {#sec-apis}
...
|               |           |              | Markdown/Jupyter         |
+---------------+-----------+--------------+--------------------------+
| Back End      | Ap        | API          | Functions *or* API       |
|               | plication |              |                          |
+---------------+-----------+--------------+--------------------------+
...
|                  | gateway between you and the server you're trying |
|                  | to access timed out before it got a response     |
|                  | from the server.                                 |
+------------------+--------------------------------------------------+
