...
In contrast, a data scientist is like an archaeologist. You're pointed
at a spot where there's some data and told to figure out what -- if
anything -- can be built to deliver value from it. The path to finished
data science software is usually much more meandering than general
purpose software engineering.

This has a few implications for the software you develop as a data
scientist.
