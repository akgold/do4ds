...
Let's say you're developing an app. If you read the [chapter on reproducibility](#repro), you understand that there are layers of dependencies you're accumulating, including your code, the R and Python packages your code needs, the versions of the languages themselves, and right down to the operating system.

![](images-docker/docker-usage.png){width="587"}
...
![](images-docker/docker-on-host.png){width="584"}
