...
sophisticated. I'm going to use an analogy to a more familiar layered
object to explain cloud service layers. Let's assume you're throwing a
birthday party for a friend and you're responsible for bringing the
delicious multi-layer birthday cake.[^2-1-cloud-7]
