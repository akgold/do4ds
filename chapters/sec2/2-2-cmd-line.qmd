...
Some *integrated development environments (IDEs)*, like \index{RStudio} or VS
...
a \index{Docker} \index{Container} has a shell available. That means that if you do a
...
\index{RStudio}. Others may prefer a standalone text editor. The most popular
