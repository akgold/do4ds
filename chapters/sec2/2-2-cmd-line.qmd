...
open an \index{SSH}SSH session to the remote and includes the private key with the
...
fig-alt="A diagram of \index{SSH}SSH initialization. The local host sends the private key, the remote checks against the public key, and then opens the session."}
