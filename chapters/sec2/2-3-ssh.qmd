...
from the command line of your computer.[^2-3-ssh-1]

[^2-3-ssh-1]: SSH actually can be used between any two machines,
...
numbers much, much bigger.[^2-3-ssh-2] So much so that it's basically
...
[^2-3-ssh-2]: And prime numbers generally loom large in the operation.
...
default name, probably `id_ed25519`.[^2-3-ssh-3] If you're only creating
...
[^2-3-ssh-3]: The pattern is `id_<encryption type>`. `ed25519` is the
