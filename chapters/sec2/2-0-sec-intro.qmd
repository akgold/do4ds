...
This section will teach you the basics of being your own IT/Admin.
...
to connect to your server for administration purposes using SSH.

Unlike the Apple, Windows, or Android operating systems on your personal
devices, most servers run the Linux operating system. [Chapter
@sec-linux] will teach you a little about what Linux is and introduce
you to the basics of Linux administration, including how to think about
files and users on a multi-tenant server.
...
data science tools like R, Python, \index{RStudio}, \index{JupyterHub}, and more. You'll
...
section. The labs in this section will focus on putting that project
into production.
...
You'll add R, Python, \index{RStudio Server}, and \index{JupyterHub} to your server and
get them configured. Additionally, you'll deploy the \index{Shiny} App and \index{API}
...
mass prediction \index{Shiny} App to the Quarto website you created in the
