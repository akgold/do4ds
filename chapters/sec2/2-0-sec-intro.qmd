...
There's only one lab in this section. Most of the chapters in this
section are just introductions to tools you'll need later on, so they
don't have labs.

[Chapter @sec-docker] on using Docker does include a lab. You'll take
the API and app you created in the last section and learn how to
Docker-ize them.
