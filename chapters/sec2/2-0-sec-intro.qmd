...
operating system isn't what you're used to. In order to effectively
administer a server, you'll need to learn a little bit about what Linux
is, a basic introduction to Linux administration, and develop an
understanding of how files and users work on Linux. Linux, and basic
Linux system administration is the topic of [Chapter @sec-linux].
...
In this section, we'll stand up a server, configure the command line and
SSH, add users, and create a data science workbench with R, Python,
