...
Because MacOS is closely related to Linux, many of these commands will
also work on Macs, but not all.
:::
...
|                 |                      | a live view.         |
+-----------------+----------------------+----------------------+
| `gr e           | Search a file using  | Writing regex can be |
| p <expression>` | regex.               | a pain. I suggest    |
|                 |                      | testing expressions  |
|                 |                      | on regex101.com.     |
|                 |                      |                      |
|                 |                      | Often useful in      |
...
+================+================+========================+
| `touch`        | Creates file   | Updates last updated   |
|                | if doesn't     | to current time if it  |
|                | already exist. | does exist.            |
+----------------+----------------+------------------------+
...
|                | file in `vim` (from  | to save and     |
|                | normal mode)         | quit in one,    |
|                |                      | `:wq`           |
+----------------+----------------------+-----------------+
