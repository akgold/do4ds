...
``` {.python eval="false" include="../../_labs/docker/docker-local/build-docker-local.qmd" start-line="9" end-line="13"}
```

Once you've generated your Dockerfile, take a look at it. Here's the one
for my model:

``` {.Dockerfile eval="false" include="../../_labs/docker/docker-local/docker/Dockerfile" filename="Dockerfile"}
```
...
``` {.Python eval="false" include="../../_labs/docker/docker-local/docker/app.py" filename="app.py"}
```
