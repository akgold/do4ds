...
The theory of why this works is deep and fascinating.[^3-9-resources-1]
...
[^3-9-resources-1]: The reason why this is the case and how it works is
...
computer turns off, the RAM gets wiped.[^3-9-resources-2]

[^3-9-resources-2]: You probably don't experience this personally.
    Modern computers are pretty smart about dumping RAM onto the hard
    disk before shutting down, and bringing it back on startup, so you
