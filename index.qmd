...
This website is (and always will be) **free to use**, and is licensed under the [Creative Commons Attribution-NonCommercial-NoDerivs 3.0](https://creativecommons.org/licenses/by-nc-nd/3.0/us/) license. If you'd like a **physical copy** of the book, they will be available once it's finished!

## Software information and conventions {.unnumbered}

I used the **knitr**\index{knitr} package [@xie2015] and the **quarto**\index{quarto} package [@quarto] to compile my book.
