...
3.0](https://creativecommons.org/licenses/by-nc-nd/3.0/us/) license. If
you'd like a **physical copy** of the book, they will be available once
it's finished!
...
(e.g., `bookdown::render_book()`).

## About the Author

Alex Gold leads the Solutions Engineering team at
[RStudio](www.rstudio.com).

He works with customers of RStudio's professional software to help them
deploy, configure, and use RStudio's professional software and open
source tooling in R and Python.
...
Tea Green: CAFFDO Steel Blue: 3E7CB1 Kombu Green: 273c2c Bright Maroon:
B33951 Sandy Brown: FCAA67
